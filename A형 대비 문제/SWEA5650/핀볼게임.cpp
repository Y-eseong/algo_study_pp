...
{
	if (holenum == 6)whole6.push_back({ i, j });
	else if (holenum == 7)whole7.push_back({ i, j });
	else if (holenum == 8)whole8.push_back({ i, j });
	else if (holenum == 9)whole9.push_back({ i, j });
	else if (holenum == 10)whole10.push_back({ i, j });
}
